...
│   └── kam2-us-logo.png
│
├── index.html                    # Tab title: Kam2-US Agrovet POS
...
```bash
git clone https://github.com/aineahmarabi/Kam2-US Agrovet POS.git
cd Kam2-US Agrovet POS
```
...
Private — all rights reserved. Built for Kam2-US Agrovet Perfume Shop.
