    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Apply Discount" maxWidth="sm">
      <div className="space-y-4">
          ...
          <button
            ...
            className={`flex-1 h-10 rounded-md border text-sm font-medium transition-colors ${
              type === "percent"
                ...
                : "bg-white text-[#5C6B5C] border-[#E3DCC8] hover:bg-[#F7F3E9]"
            }`}
          >
            Percentage (%)
          </button>
        ...
        {parseFloat(value) > 0 && !isNaN(parseFloat(value)) && (
          <div className="bg-[#F7F3E9] rounded-md p-3 text-sm">
            <div className="flex justify-between text-[#5C6B5C]">
              <span>Subtotal</span>
            ...
            <div className="flex justify-between text-[#2C5F2D] font-semibold mt-1 pt-1 border-t border-[#E3DCC8]">
