...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "primary", size = "md", loading, className, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: "bg-[#2C5F2D] text-white hover:bg-[#1B3E1C]",
      secondary: "bg-white border border-[#E3DCC8] text-[#2C5F2D] hover:bg-[#F7F3E9]",
      danger: "bg-[#DC2626] text-white hover:bg-[#b91c1c]",
      ghost: "bg-transparent text-[#5C6B5C] hover:bg-[#E3DCC8]",
    };
